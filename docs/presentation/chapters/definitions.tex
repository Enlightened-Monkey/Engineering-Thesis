  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.53\textwidth}
      \begin{itemize}
        ...
        \item \textbf{Polityka} $\pi$ to reguła decyzyjna mapująca stany (lub historie) na rozkłady akcji.
    ...
    \begin{column}{0.42\textwidth}
      ...
      \vspace{0.4em}
      \small Schemat pętli interakcji agent--środowisko.
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Quasi-hiperboliczne uczenie poprzez wzmocnienie}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.4\textwidth}
      \centering
      \includegraphics[width=\linewidth]{../../data/plots/discounting_comparison.png}
      \vspace{0.4em}
