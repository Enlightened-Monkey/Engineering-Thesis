...
\begin{frame}{Dowód redukcji polityk (1/2)}
  ...
  \[
    J_{\phi}^{\alpha,\beta}(s) = \mathbb{E}\!\left[ r(s_0,a_0) + \alpha \sum_{t=1}^{\infty} \beta^{t}\, r(s_t,a_t) \;\middle|\; s_0 = s \right].
  \]
  Warunkując po pierwszej akcji $a_0 \sim \phi_0(\cdot \mid s)$ dostajemy
  \[
    J_{\phi}^{\alpha,\beta}(s) = \mathbb{E}_{a_0 \sim \phi_0(\cdot \mid s)}\!\left[ r(s,a_0) + \alpha\,\mathbb{E}\!\left[ \sum_{t=1}^{\infty} \beta^{t}\, r(s_t,a_t) \;\middle|\; s_0 = s, a_0 \right] \right].
  \]
  Kolejne warunkowanie względem $s_1 \sim q(\cdot \mid s,a_0)$ daje
  \[
    J_{\phi}^{\alpha,\beta}(s) = \mathbb{E}_{\substack{a_0 \sim \phi_0(\cdot \mid s) \\ s_1 \sim q(\cdot \mid s,a_0)}}\!\left[ r(s,a_0) + \alpha\,\mathbb{E}\!\left[ \sum_{t=1}^{\infty} \beta^{t}\, r(s_t,a_t) \;\middle|\; s_1 \right] \right].
  \]
\end{frame}
...
\begin{frame}{Dowód redukcji polityk (2/2)}
  ...
  \[
    \mathbb{E}\!\left[ \sum_{t=1}^{\infty} \beta^{t}\, r(s_t,a_t) \;\middle|\; s_1 \right] = \beta\,J^{\beta}_\phi(s_1),
  \]
  ...
  \[
    J^{\beta}_\phi(s') = J^{\beta}_{\phi_s}(s'), \qquad \forall s' \in S.
  \]
  Podstawiając do poprzedniego równania, otrzymujemy
  \[
    J_{\phi}^{\alpha,\beta}(s) = \mathbb{E}_{\substack{a_0 \sim \phi_0(\cdot \mid s) \\ s' \sim q(\cdot \mid s,a_0)}}\!\left[ r(s,a_0) + \alpha\,\beta\, J^{\beta}_{\phi_s}(s') \right].
  \]
